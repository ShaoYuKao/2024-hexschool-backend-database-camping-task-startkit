...
INSERT INTO "COACH" ("user_id", "experience_years", "created_at", "updated_at") VALUES
...
-- 新增專長
INSERT INTO "SKILL" ("name", "created_at") VALUES ('空中瑜伽', CURRENT_TIMESTAMP);
...
VALUES (
  (SELECT "id" FROM "USER" WHERE "email" = 'lee2000@hexschooltest.io'), -- 教練李燕容的 user_id
  (SELECT "id" FROM "SKILL" WHERE "name" = '重訓'), -- 專長為重訓的 skill_id
  '重訓基礎課', -- 課程名稱
  NULL, -- 描述可以留空
...
VALUES (
  ...
  (SELECT "id" FROM "COURSE" WHERE "name" = '重訓基礎課' AND "user_id" = (SELECT "id" FROM "USER" WHERE "email" = 'lee2000@hexschooltest.io')),
  '2024-11-24 16:00:00',
  '即將授課',
  CURRENT_TIMESTAMP
);
...
WHERE "user_id" = (SELECT "id" FROM "USER" WHERE "name" = '王小明')
  AND "course_id" = (SELECT "id" FROM "COURSE" WHERE "name" = '重訓基礎課' AND "user_id" = (SELECT "id" FROM "USER" WHERE "email" = 'lee2000@hexschooltest.io'))
  AND "status" = '即將授課';
...
WHERE DATE_TRUNC('month', "CREDIT_PURCHASE"."purchase_at") = '2024-11-01'
...
FROM "CREDIT_PURCHASE"
WHERE DATE_TRUNC('month', "purchase_at") = '2024-11-01';
...
FROM "COURSE_BOOKING"
WHERE DATE_TRUNC('month', "created_at") = '2024-11-01'
  AND "status" != '課程已取消';
